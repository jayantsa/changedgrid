	    ...
	    ColumnController.prototype.setState = function (columnState) {
	        ...
	        if (columnState) {
	            columnState.forEach(function (stateItem) {
	                ...
	                var aggFuncValid = [column_1.default.AGG_MIN, column_1.default.AGG_MAX, column_1.default.AGG_SUM,column_1.default.AGG_AVG].indexOf(stateItem.aggFunc) >= 0;
	                if (aggFuncValid) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ValuesSelectionPanel = (function () {
	    ...
	    ValuesSelectionPanel.prototype.cellRenderer = function (params) {
	        ...
	        agValueType.setModel([column_1.default.AGG_SUM, column_1.default.AGG_MIN, column_1.default.AGG_MAX,column_1.default.AGG_AVG]);
